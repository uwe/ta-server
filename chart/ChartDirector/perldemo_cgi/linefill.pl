...
my $data0 = [70, 73, 80, 90, 95, 93, 82, 77, 82, 101, 111, 115];
my $data1 = [90, 96, 89, 77, 82, 96, 109, 109, 99, 108, 96, 91];
my $data2 = [58, 34, 25, 49, 64, 10, 16, 40, 25, 49, 40, 22];

# The labels for the line chart
my $labels = ["2008-01", "2008-02", "2008-03", "2008-04", "2008-05", "2008-06",
...
my $title = $c->addTitle("Inter-line Coloring", "ariali.ttf", 15);
...
# lines.
my $plotArea = $c->setPlotArea(70, 65, $c->getWidth() - 100, $c->getHeight() - 110,
...
$c->xAxis()->setLabelStyle("Arial", 8, $perlchartdir::TextColor, 90);

# Add a spline curve to the chart
my $layer0 = $c->addSplineLayer($data0, 0xff0000, "Data Set 0");
$layer0->setLineWidth(2);

# Add a normal line to the chart
my $layer1 = $c->addLineLayer($data1, 0x008800, "Data Set 1");
...
my $layer2 = $c->addLineLayer($data2, 0x0000ff, "Data Set 2");
$layer2->setLineWidth(2);

# Add a horizontal mark line to the chart at y = 40
my $mark = $c->yAxis()->addMark(40, -1, "Threshold");
$mark->setLineWidth(2);
...
$mark->setAlignment($perlchartdir::Left);
