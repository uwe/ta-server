...
$c->addScatterLayer($dataX, $dataY, "", perlchartdir::Cross2Shape(0.2), 7, 0x000000);
...
my $cAxis = $layer->setColorAxis(245, 455, $perlchartdir::TopCenter, 330,
    $perlchartdir::Top);

# Add a bounding box to the color axis using the default line color as border.
$cAxis->setBoundingBox($perlchartdir::Transparent, $perlchartdir::LineColor);
